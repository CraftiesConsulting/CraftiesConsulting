			...
			<footer class="footer">
				<div class="container">
					<div class="row">
						<!-- About -->
						<div class="col-sm-3">
							<div class="heading-footer"><h4>need a website?</h4></div>
							<p>Need a website that suit its purpose?</p>
							<a href="{{ url('contact') }}" class="btn btn-primary btn-rw mt10">
								Contact us
							</a>
						</div>
						...
						<div class="col-sm-3 mg25-xs">
							...
							<p><span class="ion-home footer-info-icons"></span><small class="address">14, Umaru Audi Road, G.R.A Ilorin, Kwara State Nigeria</small></p>
							<p><span class="ion-email footer-info-icons"></span><small class="address"><a href="mailto:info@craftiesconsulting.com">info@craftiesconsulting.com</a></small></p>
							<p><span class="ion-ios7-telephone footer-info-icons"></span><small class="address">+2349097756145</small></p>
						</div>
						...
						<div class="col-sm-3 hidden-xs">
							...
							<div class="col-xs-4 recent-work-padding">
								<a href="http://www.almawridschoools.com" class="thumbnail">
					...
					<div class="row">
						...
						<div class="col-sm-11 col-xs-10">
							<p class="copyright">© 2015 Design by <b><a href="{{ url('/') }}">Crafties Consulting Limited</a></b></p>
						</div>
